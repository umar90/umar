...
echo "<li>";
	...
	protected function renderDataCellContent($row,$data)
	{
		...
		ob_end_clean();
		echo "<div class='btn-group'><button class='btn btn-mini dropdown-toggle' data-toggle='dropdown'>
		Action <span class='caret'> </span></button><ul class='dropdown-menu' style='min-width: 100px; padding:5px;'>".strtr($this->template,$tr)."</ul></div>";
	}
}
